...
export const metadata: Metadata = {
  ...
  // `icons.icon` is auto-generated by Next.js from `src/app/icon.svg`
  // (file-based metadata). Keeping it only in `/public` without the
  // app-route variant meant `/favicon.ico` 404'd and browsers fell
  // back to their default (e.g. Vercel's "V" placeholder) whenever
  // the page was hard-refreshed before the metadata link resolved.
  appleWebApp: {
    capable: true,
