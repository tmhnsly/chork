...
/**
 * Detail view for a single achievement — the BODY only; the
 * AchievementsOverlay owns the sheet chrome (title, back, close).
 * Structure:
 *
 ...
 */
export function AchievementDetailBody({ badge }: Props) {
