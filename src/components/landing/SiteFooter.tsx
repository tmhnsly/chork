 ...
 * one tap away regardless of entry point. Handles its own
 * safe-area + navbar-clearance padding so the mounting page can keep
 * `padding-bottom: 0` without clipping behind the floating nav pill.
 */
